...
export async function saveTiebreakerPick(
  ...
  // Bloquear si ya se conoce el resultado FT del partido correspondiente
  const ftResult = matchIdx === 0 ? ds.tbFtResult : ds.tb2FtResult;
  if (ftResult !== null) return { error: "El resultado ya fue registrado" };
