...
/**
 * Shared payment phases for a bet that has already been created (price > 0).
 * The "pick" phase is module-specific and lives in each card; this component
 * renders the pay / pending / paid states consistently across all pools.
 */
      ...
      <div className="space-y-3 flex-1 flex flex-col">
        <div className="bg-amber-400/[0.08] border border-amber-400/25 rounded-xl p-3">
          ...
          <p className="text-xs text-slate-500 mt-2 leading-relaxed">
            Realiza tu pago de <span className="text-amber-300 font-semibold">${price}</span> y el admin lo verificará. Tu apuesta queda confirmada al aprobarse.
          </p>
        </div>
        <button
          onClick={onChoosePay}
